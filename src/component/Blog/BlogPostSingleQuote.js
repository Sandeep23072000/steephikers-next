...
import styles from '../../styles/Blog/BlogPostSingleQuote.module.css'
...
const BlogPostSingleQuote = () => {
    return (
        <>

            <section className='mt-5 mb-2'>
                <div className={styles.blog_quote}>
                    <div className={styles.blog_quote_logo}>
                    ...
                    <div className='container'>
                        <div className='row'>
                            <div className='col-lg-9'>
                                <div className={styles.blog_list_section45}>
                                    <div className='mt-5'>
                                        <div className={styles.blog_quote_heading1}>
                                            <div className={styles.blog_quote_heading_about}>
                                                <span>&#10078;</span>
                                    ...
                                    <div className={styles.blog_list_section4}>
                                        <div className={styles.blog_quote_heading}>
                                            <a>Spain</a>
                                            <h3>Explore</h3>
                                        </div>

                                        <div className={styles.blog_quote_paragraph}>
                                            <p>
                                            ...
                                            <div className={styles.blog_quote_paragraph4}>
                                                <div className={styles.blog_quote_about1}>
                                                    <a>
                                            ...
                                            <div className={styles.standard_footer_paragraph8}>
                                                <p>
                                    ...
                                    <div className='mt-5'>
                                        <div className='row'>
                                            <div className='col-lg-6 col-md-6 col-sm-12 col-12'>
                                                <div className={styles.blog_post_singles_quote_img}>
                                            ...
                                            <div className={styles.blog_post_quote_img_about}>
                                                <p>
                                            ...
                                            <div className={styles.blog_quote_button}>
                                                ...
                                                <div className={styles.blog_quote_like}>
                                                    <a><i class="bi bi-heart"></i></a>
                                                    <span>20</span>
                                                </div>

                                                <div className={styles.blog_quote_msg}>
                                                    <a><i class="bi bi-chat"></i></a>
                                                    <span>3</span>
                                                </div>
                                            </div>

                                            <div className={styles.blog_quote_footer_about}>
                                                <div className='row'>
                                                    <div className='col-12  col-sm-12 col-md-4'>
                                                        <div className={styles.blog_quote_footer_about1}>
                                                    ...
                                                    <div className='col-12  col-sm-12 col-md-4'>
                                                        <div className={styles.blog_quote_footer_about_date}>
                                            ...
                                            <div className={styles.blog_quote_navigation}>
                                                <div className={styles.blog_quote_navigation_inner}>
                                                    <div className={styles.blog_quote_navigation_img}>
                                                        <a>
                                                            <img src='../Assets/Blog_quote1.jpg' />
                                                ...
                                                <div className={styles.blog_quote_navigation_inner2}>

                                                    <h5>next post</h5>
                                                    <div className={styles.blog_quote_navigation_img}>
                                                        <a>
                                                            <img src='../Assets/Blog_quote2.jpg' />
...
export default BlogPostSingleQuote
