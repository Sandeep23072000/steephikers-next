...
import styles from '../../styles/Blog/BlogPostSinglesVideo.module.css'
...
const BlogPostSinglesVideo = () => {
    return (
        <>
            <section className='mt-4 mb-2'>
                <div className={styles.blog_video}>
                    <div className={styles.blog_video_logo}>
                    ...
                    <div className='container'>
                        <div className='row'>
                            <div className='col-lg-9'>
                                <div className={styles.blog_video23}>
                                    <div className='mt-5'>
                                        <div className={styles.blog_video_img_top}>
                                    ...
                                    <div className='mt-5'>
                                        <div className={styles.blog_video_heading1}>
                                            <div className={styles.blog_video_heading_about}>
                                                <a>Australia</a>
                                                <h3>Travel Across Three Continents  </h3>
                                                <span>Wanderlust</span>
                                            </div>
                                        </div>

                                        <div className={styles.blog_video_paragraph}>
                                            <p>
                                            ...
                                            <div className={styles.blog_video_paragraph4}>
                                                <div className={styles.blog_video_about1}>
                                                    <a>
                                            ...
                                            <div className={styles.standard_footer_paragraph10}>
                                                <p>
                                            ...
                                            <div className='mt-5'>
                                                <div className='row'>
                                                    <div className='col-lg-6 col-md-6 col-sm-12 col-12'>
                                                        <div className={styles.blog_post_singles_video_img}>
                                                    ...
                                                    <div className={styles.blog_post_video_img_about}>
                                                        <p>
                                                    ...
                                                    <div className={styles.blog_video_button}>
                                                        ...
                                                        <div className={styles.blog_video_like}>
                                                            <a><i class="bi bi-heart"></i></a>
                                                            <i>20</i>
                                                        </div>

                                                        <div className={styles.blog_video_msg}>
                                                            <a><i class="bi bi-chat"></i></a>
                                                            <i>3</i>
                                                        </div>
                                                    </div>
                                                    <div className={styles.blog_video_footer_about}>
                                                        <div className='row'>
                                                            <div className='col-12  col-sm-12 col-md-4'>
                                                                <div className={styles.blog_video_footer_about1}>
                                                            ...
                                                            <div className='col-12  col-sm-12 col-md-4'>
                                                                <div className={styles.blog_video_footer_about_date}>
                                                    ...
                                                    <div className={styles.blog_video_navigation}>
                                                        <div className={styles.blog_video_navigation_inner}>
                                                            <div className={styles.blog_video_navigation_img}>
                                                                <a>
                                                        ...
                                                        <div className={styles.blog_video_navigation_inner2}>
...
export default BlogPostSinglesVideo
